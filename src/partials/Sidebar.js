      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink exact to="/" className="block">
            <img className=" w-8 h-8" src="https://desarrollo.consigueventas.com/Frontend/Recursos/logoCompleto.png" alt="" />
          </NavLink>
        </div>
                      ...
                      <a href="#0" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('people') && 'hover:text-gray-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex flex-shrink-0 ml-2">
                            <svg className={`w-3 h-3 flex-shrink-0 ml-1 fill-current text-gray-50 ${open && 'transform rotate-180'}`} viewBox="0 0 12 12">
          ...
          <div className="px-3 py-2">
            <button onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              ...
              <svg className="w-6 h-6 fill-current sidebar-expanded:rotate-180" viewBox="0 0 24 24">
                <path className="text-gray-50" d="M19.586 11l-5-5L16 4.586 23.414 12 16 19.414 14.586 18l5-5H7v-2z" />
