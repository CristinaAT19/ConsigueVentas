            ...
            <div className="w-4/5 mx-auto mt-14">
                ...
                <div className="rounded-b-2xl shadow-md bg-white flex flex-wrap items-baseline justify-center p-5">
                    ...
                    <div className="flex items-center justify-between gap-5 py-2 mt-3">
                        <button className="flex items-center justify-center w-56 bg-gray-700 text-gray-50 h-1/5 py-2 rounded-md" onClick={handleChangePass} >Cambiar Contraseña</button>
                        <button className="flex items-center justify-center w-56 bg-gray-700 text-gray-50 h-1/5 py-2 rounded-md" onClick={clearInputs}>Limpiar</button>
                    </div>
                </div>
            </div>
        </>
